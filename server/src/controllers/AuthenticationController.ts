...
export class AuthenticationController extends BaseController {
    public constructor(app: Express, db: Db) {
        ...
        app.route(Config.webServer.apiUrlPrefix + "/auth/google/init")
           .get(passport.authenticate("google", {session: false, scope: ["openid", "profile", "email"]}));

        app.route(Config.webServer.apiUrlPrefix + '/auth/google/callback')
           .get(passport.authenticate("google", {session: false}), AuthenticationController.generateJwt);
